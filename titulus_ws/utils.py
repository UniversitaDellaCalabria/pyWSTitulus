from titulus_ws.settings import DOCUMENTO_ENTRATA_PATH, FASCICOLO_PATH
...
def format_xml_doc(
    ...
    xml = xml.format(
        ...
        # PER FASCICOLARE è NECESSARIA CONCORDANZA CON RESP FASCICOLO
        nome_rif_interno=nome_riferimento_interno,
